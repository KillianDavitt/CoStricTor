...
func main() {
	...
	hstsProp := 0.2
	httpProp := 0.2
	filterSizes := []interface{}{4096,8192,16384}
	sampleSizes := []interface{}{30}
	numSites := 10000
	primaryThresholds := []interface{}{0.01,0.005,0.001,0.0005,0.0001,0.00001}
	secondaryThresholds := []interface{}{0.5,0.1,0.05,0.01,0.005,0.001,0.0005}
	ps := []interface{}{0.1,0.2,0.25}
	qs := []interface{}{0.75,0.8,0.9}
