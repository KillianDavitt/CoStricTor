...
func main() {
	...
	qs := [18]float64{0.9988905440229229, 0.9986599476383371, 0.9978767930134134, 0.9962956450020221, 0.9933071490757152, 0.9879368700291202, 0.9791084544732513, 0.9672734436346139, 0.9607296994499493,0.95,0.9,0.85,0.8,0.75,0.7,0.65,0.6,0.55}
	//for i:=1; i<200; i++ {
