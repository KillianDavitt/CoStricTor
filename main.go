...
func main() {
	...
	hstsProp := 0.2
	httpProp := 0.2
	filterSizes := []interface{}{4096,8192,16000,32000,50000}
	sampleSizes := []interface{}{3000000}
	numSites := 10000
	primaryThresholds := []interface{}{0.01,0.005,0.001,0.0007,0.0005,0.0001,0.00001,0.000005,0.000001,0.0000001}
	secondaryThresholds := []interface{}{0.8,0.5,0.1,0.05,0.01,0.005,0.001,0.0005,0.0001,0.00001}
	ps := []interface{}{0.1}
	qs := []interface{}{0.9}
	numsHashes := []interface{}{1,4,8,16,32}
