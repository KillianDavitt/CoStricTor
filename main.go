...
func main() {
	...
	filterSizes := [12]int{25000,50000,75000,100000,125000,150000,175000,200000,225000,250000,275000,300000}//500,1000,1500,2000,2500,3000,3500,4000,4500,5000,5500,6000,6500,7000,7500,8000}
