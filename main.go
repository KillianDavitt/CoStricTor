...
func main() {
	...
	filterSizes := [38]int{1000,1500,2000,2500,3000,3500,4000,4500,5000,5500,6000,6500,7000,7500,8000,8500,9000,9500,10000,10500,11000,11500,12000,12500,13000,13500,14000,14500,15000,15500,16000,16500,17000,17500,18500,19000,19500,20000}//500,1000,1500,2000,2500,3000,3500,4000,4500,5000,5500,6000,6500,7000,7500,8000}
	...
	for i:=0; i<len(filterSizes); i++ {
		//for j:=0; j<len(secondaryThreshs); j++ {
			p := []interface{}{filterSizes[i],3000000,0.000005,0.9,0.045,0.07}
