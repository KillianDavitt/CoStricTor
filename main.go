...
func main() {
	...
	ps := [9]float64{0.12995149343859222, 0.0027281825552509286, 0.01981333734650907, 0.00738136679298443, 0.0520850061724844, 0.28876540577240617, 0.0003700923931708333, 0.5246331135813284, 0.0010053760853966232}
	qs := [1]float64{0.75}
	//for i:=1; i<200; i++ {
